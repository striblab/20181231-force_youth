...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/force-youth">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/force-youth/",
      "url": "http://static.startribune.com/news/projects-staging/all/force-youth/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/force-youth/",
      "url": "http://static.startribune.com/news/projects/all/force-youth/"
    }
  }
}
```
